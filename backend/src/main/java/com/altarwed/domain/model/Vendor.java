...
public record Vendor(
        ...
        String websiteUrl,
        String phone,
        // V57: optional public contact email, separate from login email
        String contactEmail,
    ...
    public Vendor withVerified() {
        return new Vendor(id, businessName, category, city, state, email, passwordHash,
                ...
                bio, description, websiteUrl, phone, contactEmail, logoUrl, viewCount, createdAt, LocalDateTime.now());
    }
    ...
    public Vendor withLogoUrl(String url) {
        return new Vendor(id, businessName, category, city, state, email, passwordHash,
                isChristianOwned, denominationIds, isActive, isVerified, priceTier,
                bio, description, websiteUrl, phone, contactEmail, url, viewCount, createdAt, LocalDateTime.now());
    }
