      ...
      <div className="w-full max-w-lg">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-[#e8dcc8] p-8 space-y-5 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="reg-category" className={cls.label}>Category *</label>
              <select id="reg-category" required value={form.category} onChange={set('category')} className={cls.input}>
          ...
          <label className="flex items-center gap-3 cursor-pointer">
            <input id="reg-christianOwned" type="checkbox" checked={form.isChristianOwned} onChange={set('isChristianOwned')}
