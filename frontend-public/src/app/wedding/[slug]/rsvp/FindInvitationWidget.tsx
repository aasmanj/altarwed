    ...
    <div className="space-y-6">
      <form onSubmit={handleSearch} className="flex gap-3">
        ...
        <button
          ...
          className="rounded-xl bg-[#d4af6a] px-6 py-3 font-semibold text-white shadow transition hover:bg-[#b8963e] disabled:opacity-50 disabled:cursor-not-allowed"
        >
        ...
        <div role="status" className="space-y-3">
          ...
          {results.map((r, i) => (
            ...
            >
              ...
              <a
                href={`/rsvp/${r.token}`}
                className="rounded-lg bg-[#d4af6a] px-5 py-2 text-sm font-semibold text-white shadow transition hover:bg-[#b8963e]"
              >
                RSVP Now
              </a>
            </div>
